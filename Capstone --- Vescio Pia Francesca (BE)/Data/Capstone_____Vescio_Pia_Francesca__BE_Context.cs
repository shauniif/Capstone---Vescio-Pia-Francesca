...
namespace Capstone_____Vescio_Pia_Francesca__BE_.Data
{
    public class Capstone_____Vescio_Pia_Francesca__BE_Context : DbContext
    {
        ...
        public DbSet<Capstone_____Vescio_Pia_Francesca__BE_.Entity.Comment> Comment { get; set; } = default!;
        public DbSet<Capstone_____Vescio_Pia_Francesca__BE_.Entity.Article> Article { get; set; } = default!;
        public DbSet<Capstone_____Vescio_Pia_Francesca__BE_.Entity.User> User { get; set; } = default!;
    }
}
